// Voglio connettermi alla table "anomalies" del db e stampare il contenuto
...
#define ANOMALIESTABLENAME "anomalies"
...
int main(){
    ...
    query += ANOMALIESTABLENAME;
    query += ";";
    // Ottengo il numero di entry dentro log, lo uso per poi stampare
